...
/// regular Season 6 Episode 3 client.
/// </summary>
[Guid("EBE2FFAD-074F-4357-BC6D-AFBF17866D38")]
[PlugIn]
[Display(Name = nameof(PlugInResources.DataInitializationSeasonOne_Name), Description = nameof(PlugInResources.DataInitializationSeasonOne_Description), ResourceType = typeof(PlugInResources))]
public class DataInitialization : DataInitializationBase
{
    ...
    /// </summary>
    public static string Id => "season1-classic";

    /// <inheritdoc />
    public override string Key => Id;

    /// <inheritdoc />
    public override string Caption => "Season 1 Classic (custom)";
    ...
    {
        // Same client protocol as Season 6 Episode 3 - we only trim server-side content.
